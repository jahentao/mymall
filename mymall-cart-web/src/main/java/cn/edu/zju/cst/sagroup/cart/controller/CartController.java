package cn.edu.zju.cst.sagroup.cart.controller;
...
public class CartController {
    ...
    public String addCartItem(@PathVariable Long itemId, @RequestParam(defaultValue = "1") Integer num,
        ...
        // 6、把购车商品列表写入cookie。
        CookieUtils.setCookie(request, response, MYMALL_CART, JsonUtils.objectToJson(cartList), CART_EXPIRE, true);
        return "cartSuccess";
    }
    ...
    private List<TbItem> getCartListFromCookie(HttpServletRequest request) {
        //取购物车列表
        String json = CookieUtils.getCookieValue(request, MYMALL_CART, true);
        //判断json是否为null
    ...
    public String showCartList(HttpServletRequest request, HttpServletResponse response) {
        ...
        if (user != null) {
            ...
            // 删除Cookie中购物车列表
            CookieUtils.deleteCookie(request, response, MYMALL_CART);
